...
class A2C_bot:
    ...
    def __init__(self, env_name):
        ...
        self.Actor, self.Critic = MyModel(input_shape=self.state_size, action_space = self.action_size, lr=self.lr)
    ...
    def replay(self):
        ...
        critic_value = discounted_r - values

        self.Actor.fit(states, actions, sample_weight=critic_value, epochs=1, verbose=0)
...
if __name__ == "__main__":
    ...
    agent = A2C_bot(env_name)
    #agent.train()
    agent.test('Models/Pong_a2c_2.h5')
